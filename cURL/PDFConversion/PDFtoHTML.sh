...
# 2. Create Task
curl --location --request GET 'https://api-server.compdf.com/server/v1/task/pdf/html?language=1' \
...
--form 'taskId="taskId"' \
--form 'password=""' \
--form 'parameter="{  \"pageOptions\": 1 ,  \"isContainAnnot\": 1 ,  \"isContainImg\": 0,\"isAllowOcr\":0,\"isContainOcrBg\":0,\"isOnlyAiTable\":0}"' \
--form 'language=""'
